...
#define uart_step_motor huart6  //定义端口
...
void Emm_V5_Reset_CurPos_To_Zero(uint8_t addr)
{
  ...
  // 发送命令
	HAL_UART_Transmit_DMA(&uart_step_motor, (uint8_t *)cmd, 4);
}
...
void Emm_V5_Read_Sys_Params(uint8_t addr, SysParams_t s)
{
  ...
  // 发送命令
  HAL_UART_Transmit_DMA(&uart_step_motor, (uint8_t *)cmd, i);
}
...
void Emm_V5_Modify_Ctrl_Mode(uint8_t addr, bool svF, uint8_t ctrl_mode)
{
  ...
  // 发送命令
  HAL_UART_Transmit_DMA(&uart_step_motor, (uint8_t *)cmd, 6);
}
...
void Emm_V5_Vel_Control(uint8_t addr, uint8_t dir, uint16_t vel, uint8_t acc, bool snF)
{
  ...
  // 发送命令
  HAL_UART_Transmit_DMA(&uart_step_motor, (uint8_t *)cmd, 8);
}
...
void Emm_V5_Pos_Control(uint8_t addr, uint8_t dir, uint16_t vel, uint8_t acc, uint32_t clk, bool raF, bool snF)
{
  ...
  // 发送命令
  HAL_UART_Transmit_DMA(&uart_step_motor, (uint8_t *)cmd, 13);
}
...
void Emm_V5_Stop_Now(uint8_t addr, bool snF)
{
  ...
  // 发送命令
  HAL_UART_Transmit_DMA(&uart_step_motor, (uint8_t *)cmd, 5);
}
...
void Emm_V5_Origin_Modify_Params(uint8_t addr, bool svF, uint8_t o_mode, uint8_t o_dir, uint16_t o_vel, uint32_t o_tm, uint16_t sl_vel, uint16_t sl_ma, uint16_t sl_ms, bool potF)
{
  ...
  // 发送命令
  HAL_UART_Transmit_DMA(&uart_step_motor, (uint8_t *)cmd, 20);
}
