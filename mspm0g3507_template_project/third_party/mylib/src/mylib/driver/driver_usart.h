#ifndef MYLIB_DRIVER_USART_H
#define MYLIB_DRIVER_USART_H
...
// 发送字节
inline void usart_send_byte(UART_HandleTypeDef* huart, uint8_t ch);
// 发送字节数组
inline void usart_send_byte_array(UART_HandleTypeDef* huart, uint8_t* byte_array, uint16_t size);
// 发送字符串
