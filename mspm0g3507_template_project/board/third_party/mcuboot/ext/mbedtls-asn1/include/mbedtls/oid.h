...
#define MBEDTLS_OID_DIGEST_ALG_SHA224                                                            \
    MBEDTLS_OID_GOV "\x03\x04\x02\x04" /**< id-sha224 OBJECT IDENTIFIER ::= { joint-iso-itu-t(2) \
                                          country(16) us(840) organization(1) gov(101) csor(3)   \
                                          nistalgorithm(4) hashalgs(2) 4 } */
#define MBEDTLS_OID_DIGEST_ALG_SHA256                                                            \
    MBEDTLS_OID_GOV "\x03\x04\x02\x01" /**< id-mbedtls_sha256 OBJECT IDENTIFIER ::= {            \
                                          joint-iso-itu-t(2) country(16) us(840) organization(1) \
                                          gov(101) csor(3) nistalgorithm(4) hashalgs(2) 1 } */

#define MBEDTLS_OID_DIGEST_ALG_SHA384                                                            \
    MBEDTLS_OID_GOV "\x03\x04\x02\x02" /**< id-sha384 OBJECT IDENTIFIER ::= { joint-iso-itu-t(2) \
                                          country(16) us(840) organization(1) gov(101) csor(3)   \
                                          nistalgorithm(4) hashalgs(2) 2 } */

#define MBEDTLS_OID_DIGEST_ALG_SHA512                                                            \
    MBEDTLS_OID_GOV "\x03\x04\x02\x03" /**< id-mbedtls_sha512 OBJECT IDENTIFIER ::= {            \
                                          joint-iso-itu-t(2) country(16) us(840) organization(1) \
