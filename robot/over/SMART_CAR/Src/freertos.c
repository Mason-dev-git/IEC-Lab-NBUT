...
void StartLED_Show(void *argument);
...
void MX_FREERTOS_Init(void) {
  ...
  LED_ShowHandle = osThreadNew(StartLED_Show, NULL, &LED_Show_attributes);
...
/* USER CODE BEGIN Header_StartLED_Show */
/**
* @brief Function implementing the LED_Show thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_StartLED_Show */
void StartLED_Show(void *argument)
{
  /* USER CODE BEGIN StartLED_Show */
  /* Infinite loop */
  for(;;)
  {
	__All_Data_Handler();
