...
extern uint16_t ad_now[10];//adc采样当前值
extern uint16_t ad_max[10];//adc采样最大值
extern uint16_t ad_min[10];//adc采样最小值
extern uint16_t ad_avr[10];//adc采样平均值
...
public:
  ...
  int32_t ad_circle_compensation();/*曲线偏心ad补偿值*/
};
